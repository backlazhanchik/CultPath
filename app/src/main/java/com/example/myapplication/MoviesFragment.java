...
public class MoviesFragment extends Fragment {
    ...
    private final List<Movie> allMovies = new ArrayList<Movie>() {{
        add(new Movie(1, "Древнейшее искусство России", "Ученые раскрывают тайны и смыслы наскальной живописи. Док об истории древнейшей культуры России", "Онлайн", "Исскувсство", "13-18", "https://www.kinopoisk.ru/series/5234123/?utm_referrer=www.google.comx", true));
        ...
        add(new Movie(3, "Арт и Факт", "Какие секреты таят в себе полотна знаменитых художников? Новеллы о шедеврах из собрания Третьяковской галереи", "Онлайн", "Искувсство", "13-18", "https://www.kinopoisk.ru/series/5304281/", true));
        add(new Movie(4, "Лесная симфония", "Жизнь фауны финских лесов — от насекомых до медведей. Впечатляющий док с отличной операторской работой", "Онлайн", "Фоклер", "13-18", "https://www.kinopoisk.ru/film/664849/", false));
